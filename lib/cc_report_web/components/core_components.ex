defmodule CcReportWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CcReportWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CcReportWeb.Gettext, "errors", msg, opts)
    end
  end
